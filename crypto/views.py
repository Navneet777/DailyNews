...
=======
from crypto.models import Contactmodel
...
try:
            ...
            def index(request):
                index_request = requests.get("https://newsapi.org/v2/everything?domains=wsj.com&pageSize=60&apiKey=104f79640cb24be5813b553c9c1352c4")
